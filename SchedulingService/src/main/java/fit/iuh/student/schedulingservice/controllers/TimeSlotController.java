...
public class TimeSlotController {
    ...
    public ResponseEntity<MessageResponse<List<TimeSlotDTO>>> getTimeSlots() {
        return SuccessEntityResponse.ok("Get time slots successfully", timeSlotService.getTimeSlots());
    }
}
