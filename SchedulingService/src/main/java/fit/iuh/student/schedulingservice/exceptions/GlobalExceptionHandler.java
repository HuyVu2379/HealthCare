package fit.iuh.student.schedulingservice.exceptions;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DuplicationDoctorScheduleException.class)
    public ResponseEntity<ErrorResponse> handleDuplicationDoctorSchedule(DuplicationDoctorScheduleException ex, HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse();
