...
//    Summary createSummary(CreateSummaryRequest summary);
    Summary updateSummary(UpdateSummaryRequest summary);
    GetSummaryResponse getSummaryByGroupId(String groupId);
}
